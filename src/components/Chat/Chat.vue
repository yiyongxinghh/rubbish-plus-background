<template>
    <div class="chat-panel">
        <div class="message-list" ref="listContainer">
            <ul>
                <template v-if="messagesArray">
                    <li v-for="message in messagesArray" class="message" :class="messageStyle(message)">
        ...
        <div class="input-area">
            <a-input v-model:value="messageObject.messageContent" placeholder="请输入消息" :autoSize="true"
