<template>
  <div class="content">
    <Banner />
    <Card :cardTitle="route.meta.title">
      <a-form
        :model="formState"
        name="basic"
        :label-col="{ span: 3 }"
      ...
      >
        ...
        >
          <a-input-group compact>
            <a-input
              v-model:value="store.userDate.userName"
              style="width: 80%"
              disabled
            />
        ...
        >
          <a-input-group compact>
            <a-input-password
              v-model:value="store.userDate.userPass"
              style="width: 80%"
        ...
        >
          <a-input-group compact>
            <a-input
              v-model:value="store.userDate.userEmail"
              style="width: 80%"
              :visibilityToggle="false"
              disabled
            />
        ...
        >
          <a-input-group compact>
            <a-input
              v-model:value="store.userDate.userPhone"
              style="width: 80%"
              :visibilityToggle="false"
              disabled
            />
    ...
    >
      ...
      <template #userPass="{ form }">
        ...
        >
          <a-input
            v-model:value="form.userPassAgain"
            :visibilityToggle="false"
          />
        </a-form-item>
      </template>
